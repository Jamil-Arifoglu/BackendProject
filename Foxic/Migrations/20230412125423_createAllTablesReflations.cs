...
{
    public partial class createAllTablesReflations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ClothesGlobalTabs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GlobalTab = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothesGlobalTabs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tagas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClothesGlobalTabId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClothesColorSizes_Colors_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothesTags", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClothesTags_Tagas_TagId",
                        column: x => x.TagId,
                        principalTable: "Tagas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothesColorSizes_ClothesId",
                table: "ClothesColorSizes",
                column: "ClothesId");

            migrationBuilder.CreateIndex(
                name: "IX_ClothesColorSizes_ColorId",
                table: "ClothesColorSizes",
                column: "ColorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothesTags_ClothesId",
                table: "ClothesTags",
                column: "ClothesId");

            migrationBuilder.CreateIndex(
                name: "IX_ClothesTags_TagId",
                table: "ClothesTags",
                column: "TagId");
        }
